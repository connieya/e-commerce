...
public enum ResultCode {
    ...
    USER_LIST_GET_SUCCESS(200, "U004", "회원 목록 조회에 성공 하였습니다. "),
    LOGIN_SUCCESS(200, "U005", "로그인에 성공 하였습니다. "),

    // product
    PRODUCT_GET_SUCCESS(200, "P001", "상품 조회에 성공하였습니다. "),
    PRODUCT_POST_SUCCESS(200, "P002", "상품 등록에 성공하였습니다. "),
    PRODUCT_ADD_STOCK_SUCCESS(200, "P003", "상품 재고 추가에 성공 하였습니다. "),
    PRODUCT_CATEGORY_POST_SUCCESS(200, "P003", "상품 카테고리 등록에 성공 하였습니다. "),
